  ...
  return (
    <main className="flex-1 flex flex-col relative overflow-hidden bg-background text-text">
      ...
      <header className="sticky top-0 z-20 h-16 shrink-0 bg-secondary-950/90 backdrop-blur-md border-b border-secondary-800 px-4 flex items-center justify-between">
        <div className="flex gap-2.5 items-center min-w-0 flex-1">
          <Button
            ...
            className="border-0 bg-transparent flex items-center justify-center rounded-full hover:opacity-80 active:scale-95 transition-all p-1 min-w-[44px] min-h-[44px]"
          >
            <Avatar
              size="md"
        ...
        <div className="flex shrink-0">
          <LogoutButton
            className="px-3 py-2 rounded-lg border border-secondary-800 hover:bg-secondary-950/80 text-danger-300 hover:text-danger-400 text-xs font-semibold min-h-[40px] flex items-center justify-center transition-all active:scale-95"
          />
        </div>
      </header>
      ...
      <div className="flex-1 p-4 flex flex-col min-h-0 gap-5 overflow-hidden">
        ...
        <Link
          href="/agenda"
          className="relative p-4 rounded-xl border border-secondary-800 bg-secondary-950/15 hover:bg-secondary-950/30 transition-all active:scale-[0.99] flex items-center justify-between gap-3 shrink-0 min-h-[56px]"
        >
          ...
          <div className="flex-1 flex flex-col min-h-0 border border-secondary-800 p-3 rounded-xl bg-secondary-950/30">
            ...
            {mySessions.length === 0 ? (
              <div className="p-8 text-center border border-dashed border-secondary-800 rounded-xl space-y-3 bg-secondary-950/40">
                ...
                <Link
                  href="/pete-pete/new"
                  className="inline-flex items-center justify-center px-5 py-3 min-h-[44px] rounded-lg bg-primary hover:bg-primary-600 text-text-950 font-bold text-xs transition-all active:scale-[0.96]"
                >
                  Scan Struk Sekarang
                </Link>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative z-10 pointer-events-none pt-2.5 pb-0.5 border-t border-secondary-800/80 flex items-center justify-between gap-2">
                        <div className="min-w-0 flex-1">
                          <span className="text-[9px] uppercase tracking-wider text-text-400 font-bold block">Total Tagihan</span>
                        ...
                        <div className="flex items-center gap-1.5 shrink-0 flex-wrap justify-end">
                          <Badge color="gray" size="sm" type="pill-color" className="font-semibold text-[10px]">
                            {totalMembers} Sohib
                          </Badge>
                          {isAllPaid ? (
                            <Badge color="success" size="sm" type="pill-color" className="font-semibold text-[10px]">
                              Lunas
                            </Badge>
                          ) : paidMembers > 0 ? (
                            <Badge color="warning" size="sm" type="pill-color" className="font-semibold text-[10px]">
                      ...
                      <div className="relative z-10 grid grid-cols-2 gap-2 pt-0.5">
                        <Button
                          ...
                          size="xs"
                          noTextPadding
                          className="w-full min-h-[44px] h-11 rounded-lg font-bold text-xs active:scale-[0.96] transition-transform"
                        >
                        ...
                        <Button
                          ...
                          size="xs"
                          noTextPadding
                          className="w-full min-h-[44px] h-11 rounded-lg font-semibold text-xs active:scale-[0.96] transition-transform"
                        >
                          <span className="inline-flex items-center justify-center gap-1.5">
      ...
      <div className="fixed bottom-6 max-w-md w-full px-5 flex justify-end z-30 pointer-events-none">
        <Button
          ...
          className="shadow-2xl shadow-primary/45 rounded-full w-14 h-14 min-w-[56px] min-h-[56px] flex items-center justify-center p-0 hover:scale-105 active:scale-[0.96] transition-transform pointer-events-auto"
        >
