...
export const filledColors: Record<BadgeColors, { root: string; addon: string; addonButton: string }> = {
    gray: {
        root: "bg-secondary-950 text-secondary-50 ring-secondary-800",
    ...
    error: {
        ...
        addon: "text-danger-500",
        addonButton: "hover:bg-danger-900 text-danger-400 hover:text-danger-500",
    },
    danger: {
        root: "bg-danger-950 text-danger-50 ring-danger-800",
        addon: "text-danger-500",
    ...
    warning: {
        root: "bg-warning-950 text-warning-50 ring-warning-800",
        addon: "text-warning-500",
        addonButton: "hover:bg-warning-900 text-warning-400 hover:text-warning-500",
    },
    orange: {
        root: "bg-warning-950 text-warning-50 ring-warning-800",
        addon: "text-warning-500",
    ...
    success: {
        root: "bg-success-950 text-success-50 ring-success-800",
        addon: "text-success-500",
        addonButton: "hover:bg-success-900 text-success-400 hover:text-success-500",
    },
    indigo: {
        root: "bg-accent-950 text-accent-50 ring-accent-800",
        addon: "text-accent-500",
        addonButton: "hover:bg-accent-900 text-accent-400 hover:text-accent-500",
    },
    purple: {
        root: "bg-accent-950 text-accent-50 ring-accent-800",
        addon: "text-accent-500",
