                ...
                {({ state }) => (
                    <>
                        ...
                        <AriaCalendarGrid weekdayStyle="short" className="w-max">
                            <AriaCalendarGridHeader className="border-b-2 border-transparent">
                                {(day) => (
                                    <AriaCalendarHeaderCell className="p-0">
                                        <div className="flex size-9 items-center justify-center text-xs font-semibold text-secondary">{day.slice(0, 2)}</div>
